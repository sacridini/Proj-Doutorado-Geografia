...
for (i in 1:length(file_list)) {
  ...
  png(paste0("~/Desktop/ma_estados_vector/", v_state_name, "_loss_eq1.png"), width = 862, height = 364)
  barplot(vt_dt$count, names.arg = anos,
          xlab = "Year", ylab = "Area in Square Meters",
          main = paste0(v_state_name, " - Year of detection of all losses with duration equal to 1 year"),
          border = "blue")
