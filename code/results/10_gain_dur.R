...
preval <- terra::rast("/media/elacerda/backup/doutorado_backup/raster/ltgee_gain_greatest_2018_seg6/mosaics/mosaic_clip_duration.tif")
...
for (r in names(bin_rasters)) {
  ...
  terra::writeRaster(result, paste0("~/doutorado/testes/gain/finais/dur/", names(bin_rasters[[r]]), "_dur.tif"),
