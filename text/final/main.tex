...
\title{Monitoramento de Longo Prazo (1985 - 2018) das Mudanças Florestais na Mata Atlântica Brasileira Utilizando Algoritmo de Detecção de Mudança Baseado em Trajetórias}
...
\section{Introdução}
A busca por um melhor entendimento dos processos e dinâmicas ocorridas na paisagem passa necessariamente por uma melhor compreensão do tempo (GREGORY). 
